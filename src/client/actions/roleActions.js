...
export function getRoles() {
  return (dispatch) => {
    ...
    return axios.get(`${types.URL}/roles`)
      .then((res) => {
        dispatch({
...
export function saveRole(role) {
  if (role.id) {
    return (dispatch) => {
      ...
      return axios.put(`${types.URL}/roles/${role.id}`, role)
        .then((res) => {
  ...
  return (dispatch) => {
    ...
    return axios.post(`${types.URL}/roles`, role)
      .then((res) => {
...
export function deleteRole(id) {
  return (dispatch) => {
    ...
    return axios.delete(`${types.URL}/roles/${id}`)
      .then(() => {
        dispatch({
